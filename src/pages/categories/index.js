...
import { httpapproveCategoryChange, httprejectCategoryChange } from '../../services/https';
...
export default function Employers() {
    ...
    return (
        <div>
            ...
            {
                tab === 0 ? (<EmployerTable tab={tab} categoryRequests={categoryRequests} />) : (<EmployerTable tab={tab} categoryRequests={categoryHistory} />)
            }
        </div>
    )
}
...
const TableData = ({ item, tab }) => {
    ...
    return (
        <>
            <CategoryModal tab={tab} handleReject={handleReject} handleApprove={handleApprove} item={item} isOpen={isOpen} closeModal={closeModal} openModal={openModal} />
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                <td class="py-3 px-6 text-left whitespace-nowrap">
                    <div class="flex items-center">
                        ...
                        <span class="font-medium">{item?.jobID?.title}</span>
                    </div>
                </td>
