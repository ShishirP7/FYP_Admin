...
const TableData = ({ item }) => {
  ...
  return (
    <>
      <Modal item={item} isOpen={isOpen} closeModal={closeModal} openModal={openModal} />
      ...
      <tr class="border-b border-gray-200 hover:bg-gray-100">
        ...
        <td class="py-3 px-6 text-center flex gap-4 justify-center">
          <button className='p-1  flex items-center justify-center gap-2 font-medium text-white rounded-md  bg-[#00C0A3]'><RiSettings2Fill size={14} /></button>
          <button onClick={openModal} className="p-1  font-medium text-white rounded-md bg-blue-700"><RiEyeFill size={14}   /></button>
          <button className='p-1  flex items-center justify-center gap-2 font-medium text-white rounded-md bg-red-500'><ImBin size={14} /></button>
        </td>
      </tr>
    </>
  )
